package com.ray.test.testingtabhostforcustomized;
...
public class MainActivity extends Activity {
    ...
    private View createTabView(final Context context, final String tag, final Integer iconId) {
        ...
        if(tag.equals("Tab 2")){
            iv.setBackgroundResource(R.drawable.tab_icon_selector2);
        }
        return view;
    }
}
